      ...
      {data.comments.map((item) => (
        <div key={item.id}>
          <div className="relative h-auto bg-white rounded-md w-full lg:w-[600px] p-4 mb-5 ">
            ...
            <div className="text-[18px]  rounded-[3px] text-moderateBlue absolute lg:left-2 lg:top-5 bottom-2  lg:ml-0  bg-lightGray lg:w-[20px] w-[55px] flex lg:flex-col justify-center items-centers lg:gap-2 gap-2 lg:h-[60px] h-6">
              <svg
                width="11"
                height="11"
